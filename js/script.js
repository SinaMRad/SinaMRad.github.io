...
brandStyle.textContent='.brand{display:flex;align-items:center;flex:0 0 auto;height:76px}.rad-brand-art{position:relative;display:block;width:210px}.rad-brand-logo{display:block;width:210px;height:auto;max-height:70px;object-fit:contain;filter:brightness(0) invert(1)}.rad-layer-mask{position:absolute;right:0;top:5px;width:54px;height:60px;background:#123a5a;display:block}.rad-layer{position:absolute;left:6px;width:42px;height:14px;clip-path:polygon(50% 0,100% 50%,50% 100%,0 50%);display:block}.rad-layer-1{top:8px;background:#d9eefc}.rad-layer-2{top:19px;background:#67b7e8}.rad-layer-3{top:30px;background:#2d6f9f}@media(max-width:1050px){.rad-brand-art,.rad-brand-logo{width:175px}.rad-layer-mask{width:45px;height:52px;top:4px}.rad-layer{left:5px;width:35px;height:12px}.rad-layer-1{top:7px}.rad-layer-2{top:17px}.rad-layer-3{top:27px}}@media(max-width:680px){.brand{height:70px}.rad-brand-art,.rad-brand-logo{width:160px}.rad-brand-logo{max-height:62px}.rad-layer-mask{width:42px;height:48px;top:4px}.rad-layer{left:4px;width:34px;height:11px}.rad-layer-1{top:7px}.rad-layer-2{top:16px}.rad-layer-3{top:25px}}';
