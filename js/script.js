...
brandStyle.textContent='.brand{display:flex;align-items:center;flex:0 0 auto;height:76px}.rad-brand-logo{display:block;width:210px;height:auto;max-height:70px;object-fit:contain}@media(max-width:1050px){.rad-brand-logo{width:175px}}@media(max-width:680px){.brand{height:70px}.rad-brand-logo{width:160px;max-height:62px}}';
